...
| 系统 | 来源 | ISO | 字节数 | 核验凭据 | glibc |
|---|---|---|---|---|---|
| 中标麒麟桌面 6.0 x86_64 | 官方 `download.cs2c.com.cn` | ✘ **已 404**（此前 200 / 3482405376 B） | — | — | — |
| 中标麒麟桌面 6.0 **i386** | archive.org[^R128] | ✔ | 3667734528 | md5 + sha1；卷标 `NeoKylin Linux Desktop 6.0` | 2.20 |
| 中标麒麟桌面 **7.0 / 7.1** | 官方**软件源**（无 ISO） | ✔ repodata 在线 | 28830 个包 | 索引 2023-10-17 | **2.20** |
| 银河麒麟 2.0 Server | archive.org[^R129] | ✔ 两张盘 | 664764416 / 448593920 | 各带 md5 | 极老 |
| 银河麒麟 V10 SP1 hwe | archive.org | ✔ | 4451975168 | md5 + sha1；卷标 `Kylin-Desktop-V10-SP1-hwe` | 2.31 |
| deepin 15.11（及 68 个历史版本） | 官方归档站 | ✔ | 2459430912 | 同目录附 `MD5SUMS`、`SHA256SUMS` | — |
...
**ABI 断层的位置在四家高度一致。** 上一代整齐落在 glibc 2.28 附近（统信 V20、麒麟信安 3.4-x、凝思 V6.0.99 与 V6.0.100 都是 2.28，银河麒麟 V10 SP1 是 2.31），新一代整齐跳到 2.38 + GCC 12 + 内核 6.6。一条 glibc 2.28 的验证线能覆盖四家的全部存量主力，2.38 的线只能覆盖新一代。本项目五个被试里 2.38 占三个、2.31 与 2.28 各一个——**覆盖面偏向新一代**，这是已知倾斜；空着的是 2.20 与 2.34 两档。
